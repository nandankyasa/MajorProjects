...
<html>
  ...
  <link href="vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
	...
	<body class="is-preload"  style="background:pink";>
		...
		<!-- Main -->
			...
			String sql="SELECT * from send_data";
		  ...
		  while(rs.next())
			{ 
				...
				<td><a href="Send_to_Hr.jsp?mail=<%= rs.getString(3) %>&&name=<%= rs.getString(1) %>&&mobile=<%= rs.getString(2)%>">Send</a></td>

...
<% String uid=request.getParameter("email");
			ResultSet rs=DBConnection.getSetup2();
			while(rs.next())
			{
					%>
<BR>
...
<td style="color: white;"><a href="GeneratePKDC?email=<%=rs.getString(2) %>">Generate</a> </td>
</tr>
<% 
}
%>
...
<div class="col-md-12" data-scroll-reveal="enter bottom move 25px, after 0.3s">
                                <div class="dash days_dash">
                                    <a href="ViewAllDCPK.jsp" class="dash_title" style="font-size: 25px;">VIEW DC'S PK</a>
                                </div>
                            </div>
	</div>
            </div> <!-- end container -->

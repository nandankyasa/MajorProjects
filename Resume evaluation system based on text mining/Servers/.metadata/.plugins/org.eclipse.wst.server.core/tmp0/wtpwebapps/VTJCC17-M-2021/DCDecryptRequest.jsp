...
<tr class="w3-blue"><th>FID</th><th>DO ID</th><th>DC ID</th><th>Status</th>
<%
try{
	while(rs.next()){
%>

<tr class="w3-card-2 w3-hover-blue-grey w3-text-white"><td><%=rs.getString(1) %><td><%=rs.getString(2) %></td><td><%=rs.getString(3) %></td>
<td><a href="DCDecryptRequest?uid=<%=rs.getString(3) %>">Approve</a> </td></tr>
...
<br><br><br>
<div class="col-md-12" data-scroll-reveal="enter bottom move 25px, after 0.3s">
                                <div class="dash days_dash">
                                    <a href="SendKeysToDC.jsp" class="dash_title" style="font-size: 25px;">SEND KEY TO DC'S</a>
                                </div>

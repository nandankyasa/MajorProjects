...
<div class="row">
<% 
String sql = "select * from keyreq where status1='Approved';";
ResultSet rs = DBConnection.getData1(sql);
%>
<BR>
<table width="100%" border="1">
<thead style="color:white;">
<tr class="w3-blue"><th>FID</th><th>DO ID</th><th>DC ID</th><th>Status</th><th>Send Keys</th>
<%
try{
	while(rs.next()){
%>
...
<td><a href="SendKeysToDC?uid=<%=rs.getString(3) %>&&fid=<%=rs.getString(1) %>&&doid=<%=rs.getString(2) %>">Send</a> </td></tr>

...
<div class="row">
<% 
String sql = "select * from dcregister where status1='Pending';";
ResultSet rs = DBConnection.getData1(sql);
%>
<BR>
<table width="100%" border="1">
<thead style="color:white;">
<tr class="w3-blue"><th>Name</th><th>Email</th><th>Gender</th><th>Mobile</th><th>Status</th></tr>
<%
try{
	while(rs.next()){
%>
...
<td><a href="DCRequest?email=<%=rs.getString(2) %>">Add</a> </td></tr>
...
<div class="col-md-12" data-scroll-reveal="enter bottom move 25px, after 0.3s">
                                <div class="dash days_dash">
                                    <a href="ViewAllDC.jsp" class="dash_title" style="font-size: 25px;">VIEW ALL DC'S</a>
                                </div>

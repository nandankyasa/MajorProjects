...
cyber-physical cloud environment</h1>
        ...
        <section id="contact" class="contact">
            <div class="container">
                ...
                <form action="PKGLogin" method="POST" >
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-lg-offset-2 col-md-offset-2">
                            <input class="" type="email" name="pkgid" id="contact_email" placeholder="PKG ID" />
                        </div> <!-- end Name -->
                        <div class="col-lg-4 col-md-4">
                            <input class="" type="password" name="pkgpassword"  placeholder="PKG Password" />
                        </div> <!-- end Email -->
                    </div>
                    <div class="row">

...
<tr class="w3-blue"><th>MID</th><th>Email</th><th>FileName</th><th>Keywords</th><th>Master Key</th>
<%
try{
	while(rs.next()){
%>
...
<td><%=rs.getString(1) %><td><%=rs.getString(2) %></td>

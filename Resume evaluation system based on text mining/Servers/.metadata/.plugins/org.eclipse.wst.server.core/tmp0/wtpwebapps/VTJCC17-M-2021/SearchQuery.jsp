                ...
                <form action="fsearch.jsp" >
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-lg-offset-2 col-md-offset-2">
                            <input class="" type="text" name="keywords" id="contact_name" placeholder="Search Query" />
                                 <button class="btn btn-custom" id="contact_submit_btn" name="contact_submit_btn"><span>Search</span></button>

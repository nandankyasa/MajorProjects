                ...
                <form action="DCRegister" method="POST" >
                    <div class="row">
                     <div class="col-lg-4 col-md-4 col-lg-offset-2 col-md-offset-2">
                            <input class="" type="text" name="name" placeholder="DC Name" />
                        </div> 
                        <div class="col-lg-4 col-md-4 col-lg-offset-2 col-md-offset-2">
        				...
        				<label for="male">Male</label>
                         ...
                         <div class="col-lg-4 col-md-4 col-lg-offset-2 col-md-offset-2">
                            <input class="" type="text" name="mobile" placeholder="DC Mobile" />
                        </div> 
                        <div class="col-lg-4 col-md-4 col-lg-offset-2 col-md-offset-2">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <a href="DCLogin.jsp" class="btn btn-custom" id="contact_submit_btn"><span>Existing DC ? </span></a>
                           </div>
                        </div>
                    </div> <!-- end button -->
                </form><!-- END FORM -->

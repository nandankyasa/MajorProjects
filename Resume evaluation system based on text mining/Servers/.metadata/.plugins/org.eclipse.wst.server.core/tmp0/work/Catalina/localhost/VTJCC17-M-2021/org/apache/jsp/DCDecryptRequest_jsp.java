 ...
 * Generated at: 2022-06-02 10:20:21 UTC
...
public final class DCDecryptRequest_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet rs = DBConnection.getData1(sql);
      ...
      out.write("<tr class=\"w3-blue\"><th>FID</th><th>DO ID</th><th>DC ID</th><th>Status</th>\r\n");
...
try{
	while(rs.next()){
      ...
      out.write("</td>\r\n");
      out.write("<td><a href=\"DCDecryptRequest?uid=");
      out.print(rs.getString(3) );
      out.write("\">Approve</a> </td></tr>\r\n");
      out.write("\r\n");
} 
	...
	e.printStackTrace();
      ...
      out.write("                                <div class=\"dash days_dash\">\r\n");
      out.write("                                    <a href=\"SendKeysToDC.jsp\" class=\"dash_title\" style=\"font-size: 25px;\">SEND KEY TO DC'S</a>\r\n");
      out.write("                                </div>\r\n");
      out.write("\r\n");
      out.write("\t</div>\r\n");

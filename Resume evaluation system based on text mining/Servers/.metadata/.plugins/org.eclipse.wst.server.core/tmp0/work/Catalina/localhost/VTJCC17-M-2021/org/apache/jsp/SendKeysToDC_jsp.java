 ...
 * Generated at: 2022-06-02 10:29:39 UTC
...
public final class SendKeysToDC_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet rs = DBConnection.getData1(sql);
      ...
      out.write("<tr class=\"w3-blue\"><th>FID</th><th>DO ID</th><th>DC ID</th><th>Status</th><th>Send Keys</th>\r\n");
...
try{
	while(rs.next()){
      ...
      out.write("</td>\r\n");
      out.write("<td><a href=\"SendKeysToDC?uid=");
      out.print(rs.getString(3) );
      out.write("&&fid=");
      out.print(rs.getString(1) );
      out.write("&&doid=");
      out.print(rs.getString(2) );
      out.write("\">Send</a> </td></tr>\r\n");
      out.write("\r\n");
} 
